...
import { rules as javascriptRules, Rules as JavascriptRules } from '@tamby-kojak/eslint-config-javascript'
...
type Rules = {
  [K in keyof typeof allRules as K extends `@typescript-eslint/${string}` ? K : never]: unknown
} & JavascriptRules
