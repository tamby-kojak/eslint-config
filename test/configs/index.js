...
const testConfig = (name, defaultConfig, configBuilder) => {
  test(name, (testContext) => {
    testContext.test('buildConfig', (buildContext) => {
      buildContext.test('should return a config object', () => {
        const config = configBuilder({});
        assert.ok(config);
        assert.strictEqual(typeof config, 'object');
      });
  
      buildContext.test('should return a config object with the correct files array', () => {
      ...
      buildContext.test('should return a config object with the correct exclude', () => {
      ...
      buildContext.test('should return a config object with the correct rules', () => {
        const config = configBuilder({
          rules: {
